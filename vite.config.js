        ...
        plugins: [
            laravel({
                input: [
                    ...
                    'resources/js/trucking2/pages/bang-ke-xe-ngoai.jsx',
                    'resources/js/trucking2/pages/bang-ke-xe-ngoai-tao.jsx',
                    'resources/js/trucking2/pages/bang-ke-xe-ngoai-xem.jsx',
