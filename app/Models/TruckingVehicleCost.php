...
{
    protected $fillable = ['vehicle_id', 'name', 'cost_type_id', 'invoice_no', 'kind', 'spend_date', 'due_date', 'amount', 'current_km', 'supplier', 'note', 'paid', 'paid_date', 'paid_method', 'paid_ref', 'paid_note', 'approved', 'photos', 'sort'];
