...
return [
    ...
    'roles' => [
        ...
        'admin' => [
            'label'       => 'Quản trị viên',
            'description' => 'Toàn quyền như Quản trị toàn quyền (chỉ khác: không phải vai trò hệ thống).',
        ...
        'ke_toan' => [
            'label'       => 'Kế toán',
            'description' => 'Mảng tài chính: bảng giá, bảng kê cần thu, phí xe & lương, yêu cầu/duyệt chi, chi phí đội xe.',
        ...
        'chung_tu' => [
            'label'       => 'Chứng từ',
            'description' => 'Lô hàng (toàn quyền) + theo dõi xe + xem danh mục + ghi chú/công việc.',
